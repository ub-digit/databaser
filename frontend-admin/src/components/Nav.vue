<template>
  <div>
    ...
    >
      ...
      <template #body>
        <p>
          <span v-if="isIndexing">Indexing please wait... (1-2 minutes)</span
      ...
      <div class="navbar navbar-dark bg-primary navbar-expand-sm">
        <div class="container-fluid">
          <a class="navbar-brand" href="/">
            <span class="logo"
              ><img :src="'/img/gub-textlogo-en.svg'" alt="logo"
            /></span>
            | Database admin
          </a>
          <div class="navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <router-link :to="{ name: 'alert' }" class="nav-link"
              ...
              <li class="nav-item">
                <router-link :to="{ name: 'mediatypeindex' }" class="nav-link"
                  >Mediatypes</router-link
                >
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'publisherindex' }" class="nav-link"
                  >Publishers</router-link
                >
              </li>
              <li class="nav-item">
                <router-link :to="{ name: 'databaseindex' }" class="nav-link"
            ...
            <ul class="navbar-nav ms-auto">
              <li
                ...
                v-if="$auth.$vm.state.authenticated"
              >
                <a
                  class="nav-link dropdown-toggle"
                  href="javascript:void(0)"
                  id="navbarLoginMenuLink"
                  aria-label="Username"
                  role="button"
